...
def get_ml_row(docket_id, scdb_case_data, scdb_justice_data):
    ...
    # Iterate over all justices tot calculate the Justice-specific features in the data up to now.
    for justice_group_name, justice_group_data in docket_before_justice_data.groupby('justice'):
        ...
        for feature_name in raw_justice_features:
            justice_dict[feature_name] = docket_justice_data.ix[docket_justice_data['justice'] == justice_group_name][
                raw_justice_features[feature_name]].copy().tolist().pop()
    ...
    all_justice_features['current_court_direction_issue_mean'] = all_justice_features[
        'justice_direction_issue_mean'].mean()
    all_justice_features['current_court_direction_issue_std'] = all_justice_features[
        'justice_direction_issue_mean'].std()

    all_justice_features['current_court_direction_circuit_origin_mean'] = all_justice_features[
        'justice_direction_circuit_origin_mean'].mean()
    all_justice_features['current_court_direction_circuit_origin_std'] = all_justice_features[
        'justice_direction_circuit_origin_mean'].std()

    all_justice_features['current_court_direction_circuit_source_mean'] = all_justice_features[
        'justice_direction_circuit_source_mean'].mean()
    all_justice_features['current_court_direction_circuit_source_std'] = all_justice_features[
        'justice_direction_circuit_source_mean'].std()

    all_justice_features['current_court_direction_petitioner_mean'] = all_justice_features[
        'justice_direction_petitioner_mean'].mean()
    all_justice_features['current_court_direction_petitioner_std'] = all_justice_features[
        'justice_direction_petitioner_mean'].std()

    all_justice_features['current_court_direction_respondent_mean'] = all_justice_features[
        'justice_direction_respondent_mean'].mean()
    all_justice_features['current_court_direction_respondent_std'] = all_justice_features[
        'justice_direction_respondent_mean'].std()

    '''
    D block features: code block for differences between derived features
    '''
    all_justice_features['diff_justice_court_direction'] = all_justice_features['justice_direction_mean'] - \
                                                           all_justice_features['current_court_direction_mean']
    all_justice_features['diff_justice_court_direction_abs'] = all_justice_features[
        'diff_justice_court_direction'].abs()
    all_justice_features['diff_justice_court_direction_issue'] = all_justice_features['justice_direction_issue_mean'] - \
                                                                 all_justice_features[
                                                                     'current_court_direction_issue_mean']
    all_justice_features['diff_justice_court_direction_issue_abs'] = all_justice_features[
        'diff_justice_court_direction_issue'].abs()
    all_justice_features['diff_justice_court_direction_petitioner'] = all_justice_features[
                                                                          'justice_direction_petitioner_mean'] - \
                                                                      all_justice_features[
                                                                          'current_court_direction_petitioner_mean']
    all_justice_features['diff_justice_court_direction_petitioner_abs'] = all_justice_features[
        'diff_justice_court_direction_petitioner'].abs()
    all_justice_features['diff_justice_court_direction_respondent'] = all_justice_features[
                                                                          'justice_direction_respondent_mean'] - \
                                                                      all_justice_features[
                                                                          'current_court_direction_respondent_mean']
    all_justice_features['diff_justice_court_direction_respondent_abs'] = all_justice_features[
        'diff_justice_court_direction_respondent'].abs()
    all_justice_features['diff_justice_lc_direction'] = all_justice_features['justice_direction_mean'] - \
                                                        all_justice_features['lc_direction']
    all_justice_features['diff_justice_lc_direction_abs'] = all_justice_features['diff_justice_lc_direction'].abs()
    all_justice_features['diff_court_lc_direction'] = all_justice_features['current_court_direction_mean'] - \
                                                      all_justice_features['lc_direction']
    all_justice_features['diff_court_lc_direction_abs'] = all_justice_features['diff_court_lc_direction'].abs()

    '''
    E block features: z-score scaling to normalize some features to their historical distribution.
    '''
    if all_justice_features['diff_justice_court_direction'].std() > 0:
        all_justice_features['diff_justice_court_direction_z'] = (all_justice_features['diff_justice_court_direction'] -
                                                                  all_justice_features[
                                                                      'diff_justice_court_direction'].mean()) / (
                                                                     all_justice_features[
                                                                         'diff_justice_court_direction'].std())
    else:
        all_justice_features['diff_justice_court_direction_z'] = -98

    if all_justice_features['diff_justice_court_direction_issue'].std() > 0:
        all_justice_features['diff_justice_court_direction_issue_z'] = (all_justice_features[
                                                                            'diff_justice_court_direction_issue'] -
                                                                        all_justice_features[
                                                                            'diff_justice_court_direction_issue'].mean()) / (
                                                                           all_justice_features[
                                                                               'diff_justice_court_direction_issue'].std())
    else:
        all_justice_features['diff_justice_court_direction_issue_z'] = -98

    if all_justice_features['diff_justice_lc_direction'].std() > 0:
        all_justice_features['diff_justice_lc_direction_z'] = (all_justice_features['diff_justice_lc_direction'] -
                                                               all_justice_features[
                                                                   'diff_justice_lc_direction'].mean()) / (
                                                                  all_justice_features[
                                                                      'diff_justice_lc_direction'].std())
    else:
        all_justice_features['diff_justice_lc_direction_z'] = -98

    if all_justice_features['diff_court_lc_direction'].std() > 0:
        all_justice_features['diff_court_lc_direction_z'] = (all_justice_features['diff_court_lc_direction'] -
                                                             all_justice_features['diff_court_lc_direction'].mean()) / (
                                                                all_justice_features['diff_court_lc_direction'].std())
    else:
        all_justice_features['diff_court_lc_direction_z'] = -98

    # Get the CASE outcome by Justice, which is based on the direction value in SCDB:
    ...
    all_justice_features['outcome'] = (all_justice_features['direction'] != all_justice_features['lc_direction']).apply(
        int)
